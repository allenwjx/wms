    ...
    auxiliary_vm = new Vue({
        ...
        methods: {
            ...
            create: function () {
                $("#formModal").modal({
                    show: true,
                    remote: __ctx + "/page/sale/auxiliary/edit",
                    backdrop: 'static'
                });
            },
            edit: function (id) {
                $("#formModal").modal({
                    show: true,
                    remote: __ctx + "/page/sale/auxiliary/edit?id=" + id,
                    backdrop: 'static'
                });
            },
            delete: function (id, enabled) {
                ...
                alertify.confirm("确定" + p + "该记录么？", function (result) {
                    if (result) {
                        $.ajax({
                            type: 'POST',
                            url: __ctx + "/sale/auxiliary/state/" + id + "/" + _enabled
                        }).done(function (data) {
                            if (data.success) {
