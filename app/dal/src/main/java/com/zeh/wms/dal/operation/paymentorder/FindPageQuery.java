...
public class FindPageQuery  extends PageQuery implements java.io.Serializable {
	...
	public FindPageQuery(String orderNo ,String otherOrderNo ,Long userId ,String code ,String paymentOrderNo ,String otherPaymentNo ,String status ,java.util.Date fromDate ,java.util.Date toDate ) {
