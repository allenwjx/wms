...
/**
 * @author allen
 * @create $ ID: Test, 18/2/27 14:45 allen Exp $
 * @since 1.0.0
 */
public class Test {
    ...
    //        String s = "WangJunxiang 19830219 Allen";
    //
    ...
    //        int compared = 54;
    //
    //        if (compared < min || compared > max) {
    //            System.out.println("error");
    //        } else if (compared == 0 && min == 0 && max == 0) {
    //            System.out.println("error");
    //        } else {
    //            while (min <= max) {
    //                for (int i = 0; i < 20; i++) {
